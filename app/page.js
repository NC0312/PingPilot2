    ...
    <div className="min-h-screen bg-[#031D27] text-white">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex mb-6 space-x-2">
          ...
          <button
            className={`px-4 py-2 rounded-lg ${filter === 'up' ? 'bg-green-600' : 'bg-gray-700'}`}
            onClick={() => setFilter('up')}
          >
            Up
          </button>
          <button
            className={`px-4 py-2 rounded-lg ${filter === 'down' ? 'bg-red-600' : 'bg-gray-700'}`}
            onClick={() => setFilter('down')}
          >
            Down
          </button>
          <button
            className={`px-4 py-2 rounded-lg ${filter === 'error' ? 'bg-yellow-600' : 'bg-gray-700'}`}
